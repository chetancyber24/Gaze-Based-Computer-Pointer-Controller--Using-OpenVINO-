...
def run_infer_pipeline_face_detection(face_detect,image,prob_threeshold,annot_flag):
     '''
     Run Inference Pipeline for face detection model which involves first pre-processing input,predict(inference), preprocess output(for next model) , annotate output(if needed) and measure inference time of each model.
     '''
...
def run_infer_pipeline_face_landmark_detection(face_lm_detect,image,bb_coord,annotated_image,annot_flag):
    '''
    Run Inference Pipeline for face landmarks detection model which involves first pre-processing input,predict(inference), preprocess output(for next model) , annotate output(if needed) and measure inference time of each model.
    '''
...
def run_infer_pipeline_head_estimation(head_pose_estimate,image,bb_coord,annotated_image,annot_flag):
    '''
    Run Inference Pipeline for head estimation model which involves first pre-processing input,predict(inference), preprocess output(for next model) , annotate output(if needed) and measure inference time of each model.
    '''
...
def run_infer_pipeline_gaze_estimation(gaze_estimate,image,left_eye_image,right_eye_image,head_angles,annotated_image,annot_flag):
    '''
    Run Inference Pipeline for gaze estimation model which involves first pre-processing input,predict(inference), preprocess output(for next model) , annotate output(if needed) and measure inference time of each model.
    '''
